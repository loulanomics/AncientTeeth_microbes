...
# load ASV counts
counts <- read.csv("./Final/Brennaman_teeth_ASVs_counts.csv")
rownames(counts) <- counts$Sample
counts <- counts[-1]


# load taxonomy
tax <- read.csv("./Final/Brennaman_teeth_ASVs_taxonomy.csv")

info <- read.csv("./Final/Brennaman_sample_info.csv")
